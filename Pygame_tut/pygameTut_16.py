...
# background Music
mixer.music.load('Hislerim.wav')  # mixer.music for longer sound effects
mixer.music.play(-1)
# Title and Icon
...
jbl_font = pygame.font.Font('freesansbold.ttf',32)

def game_over_text():
    over_text = over_font.render("GAME OVER",True,(255,255,255))
    JBL=jbl_font.render("Built by Infix Gaming",True,(0,150,250))

    screen.blit(over_text,(200,250))
    screen.blit(JBL,(370,480))
